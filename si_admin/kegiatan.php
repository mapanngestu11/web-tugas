				 ...
				 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit-kegiatan.php?id_kegiatan=<?php echo $d['id_kegiatan']; ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="hapus-kegiatan.php?id_kegiatan=<?php echo $d['id_kegiatan']; ?>" class="btn btn-danger btn-sm">Delete</a></td>
